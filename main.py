...
if __name__ == "__main__":
    ...
    # KMNISTbaker = Baker(device,n_layers=4, n_epochs=6, batch_size=32, lr=5e-4)
    # Gaussbaker = Baker(device,n_layers=4, n_epochs=1024, batch_size=256, n_repeats=8)
    # Halfmoonbaker = Baker(device,n_layers=4, n_epochs=1024, batch_size=16, n_repeats=8)
    # Cifarbaker = Baker(device,n_layers=6, n_epochs=6, batch_size=32, lr=5e-4)
    #
    # processes = [
